...
> Я не могу сам создать репозиторий/ссылку на GitHub из этого чата.  
> Но проект полностью готов: скачайте ZIP, распакуйте и залейте в свой GitHub (инструкция ниже).
